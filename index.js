...
const connectKeWA = () => {
const semar = makeWASocket({logger:pino({level:'silent'}),printQRInTerminal: true,auth: state,browser: ["Kiki Hosting Botz", "Dekstop", "3.0"]})
...
msg = denz.messages[0]
nomorOwner = ['62859260305158','62859260305158']
nomorDeveloper = ['62859260305158']
